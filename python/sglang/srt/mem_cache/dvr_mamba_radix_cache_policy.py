...
def mark_req_skip_mamba_radix_finished_insert(req: Any) -> None:
    req.dvr_mamba_radix_skip_finished_insert = True
...
def should_insert_finished_req(req: Any, *, default_is_insert: bool) -> bool:
    ...
    return bool(
        default_is_insert
        and not getattr(req, "dvr_mamba_radix_skip_finished_insert", False)
    )
...
def set_req_mamba_radix_insert_snapshot(
    ...
    req.dvr_mamba_radix_insert_snapshot = DVRMambaRadixInsertSnapshot(
...
def get_req_mamba_radix_insert_snapshot(
    ...
    return getattr(req, "dvr_mamba_radix_insert_snapshot", None)
...
def clear_req_mamba_radix_insert_snapshot(req: Any) -> None:
    req.dvr_mamba_radix_insert_snapshot = None
