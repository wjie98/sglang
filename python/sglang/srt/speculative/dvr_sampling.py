...
def dvr_chain_rejection_kernel(
    ...
    for start in range(0, VOCAB_SIZE, BLOCK_V):
        ...
        draft_values = tl.load(draft_base + offsets * stride_dp_v, mask=mask, other=0.0)
    ...
    sample_target = (all_drafts_accepted == 1) | ~residual_is_valid
...
def dvr_chain_rejection_sample(
    *,
    ...
    """Verify a top-k=1 draft chain with request-local deterministic RNG."""
